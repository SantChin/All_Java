package com.san.designpattern.prototypepattern;

import java.util.Hashtable;

//create a Shape abstract class which implements the Cloneable interface.
...
//creates three concrete classes extending the Shape class.
